    ...
    >
      ...
      <div
        ...
        style={{
          ...
          padding: "48px",
          background:
            "linear-gradient(160deg, #181F4D 0%, #11163dff 60%, #1a2456 100%)",
          position: "relative",
          overflow: "hidden",
        }}
      >
          ...
          >
            ...
            >
              ...
              <button
                ...
                onMouseEnter={(e) => {
                  if (!loading) e.currentTarget.style.background = "#252d6e";
                }}
                onMouseLeave={(e) => {
                  if (!loading) e.currentTarget.style.background = "#181F4D";
                }}
              >
