...
const CertificateConfig = React.lazy(() => import("./pages/admin/CertificateConfig"));
const AddInstructor = React.lazy(() => import("./pages/admin/AddInstructor"));
const AdminLiveProctoring = React.lazy(() => import("./pages/admin/AdminLiveProctoring"));
const AdminViolations = React.lazy(() => import("./pages/admin/AdminViolations"));
...
const AdminExamTimer = React.lazy(() => import("./pages/admin/ExamTimer/AdminExamTimer"));
...
const ChatWithStudents = React.lazy(() => import("./pages/admin/ChatWithStudents"));
...
const LearningPaths = React.lazy(() => import("./pages/instructor/LearningPaths"));
const StudentPerformance = React.lazy(() => import("./pages/instructor/StudentPerformance"));
const InstructorChat = React.lazy(() => import("./pages/instructor/InstructorChat"));
const AddPractice = React.lazy(() => import("./pages/instructor/AddPractice"));
const InstructorPracticeList = React.lazy(() => import("./pages/instructor/PracticeList"));
const InstructorGroups = React.lazy(() => import("./pages/instructor/Groups"));
const InstructorGroupChat = React.lazy(() => import("./pages/instructor/GroupChat"));
const ContestManagement = React.lazy(() => import("./pages/instructor/ContestManagement"));
const CreateContest = React.lazy(() => import("./pages/instructor/ContestManagement/CreateContext"));

// Student
const StudentDashboard = React.lazy(() => import("./pages/student/StudentDashboard"));
const StudentCourses = React.lazy(() => import("./pages/student/StudentCourses"));
const CourseDetail = React.lazy(() => import("./pages/student/CourseDetail/index"));
...
const PracticeSession = React.lazy(() => import("./pages/student/PracticeSession"));
...
const ContestDetail = React.lazy(() => import("./pages/student/WeeklyContest/ContestDetail"));
...
const CourseProgress = React.lazy(() => import("./pages/manager/CourseProgress"));
const ExamProgress = React.lazy(() => import("./pages/manager/ExamProgress"));
const ManagerCertificates = React.lazy(() => import("./pages/manager/Certificates"));
const ManagerMessages = React.lazy(() => import("./pages/manager/Messages"));

// Lazy loading spinner
const LazyFallback = () => (
  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', background: '#D8E2EB' }}>
    <div style={{ width: 40, height: 40, border: '4px solid #e2e8f0', borderTop: '4px solid #4f46e5', borderRadius: '50%', animation: 'spin 0.8s linear infinite' }} />
